...
angular.module('eagleeye')
  .provider('GoogleChartsService', function GoogleChartsServiceProvider() {
    ...
    this.setLineChartDefaultData = function(data) {
      setDefaultChartData('linechart', data);
    };

    this.setColumnChartDefaultData = function(data) {
      setDefaultChartData('columnchart', data);
    };

    this.setBarChartDefaultData = function(data) {
      setDefaultChartData('barchart', data);
    };

    this.setComboChartDefaultData = function(data) {
      setDefaultChartData('combochart', data);
    };
