...
describe('Constant:', function() {
  ...
  beforeEach(inject(function(
      ...
      _DEFAULT_CHART_OPTIONS_, _DATA_TABLE_SAMPLES_) {
  ...
  describe('DEFAULT_CHART_OPTIONS', function() {
    it('should be initialized', function() {
      expect(typeof DEFAULT_CHART_OPTIONS.linechart).toBe('object');
      expect(typeof DEFAULT_CHART_OPTIONS.columnchart).toBe('object');
      expect(typeof DEFAULT_CHART_OPTIONS.barchart).toBe('object');
      expect(typeof DEFAULT_CHART_OPTIONS.combochart).toBe('object');
      expect(typeof DEFAULT_CHART_OPTIONS.areachart).toBe('object');
      expect(typeof DEFAULT_CHART_OPTIONS.piechart).toBe('object');
    });
  });
